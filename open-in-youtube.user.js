...
function convertToYoutubeUrl(urlString) {
	try {
		...
		return `livecontainer://livecontainer-launch?bundle-name=com.google.ios.youtube.app&container-folder-name=6FF685D6-02C2-42AE-B1D5-4A8BABF4A212&url=${encodedUrl}`;
	} catch (error) {
		console.error('Error converting to LiveContainer URL:', error);
		return null;
	}
}
